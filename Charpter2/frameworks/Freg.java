...
public class Freg extends Activity implements OnClickListener {
    private final static String LOG_TAG = "Jun.jue.freg.FregActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fregService = IFregService.Stub.asInterface(
                ServiceManger.getService("freg"));
        valueText = (EditText)findViewById(R.id.edit_value);
        readButton = (EditText)findViewById(R.id.button_value);
        writeButton = (EditText)findViewById(R.id.button_value);
        clearButton = (EditText)findViewById(R.id.button_value);
    ...
    public void onClick(View v) {
        if (v.equals(readButton)) {
            ...
            try {
                Srting text = valueText.getText().toString();
