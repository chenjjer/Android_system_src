...
static void freg_create_proc(void) {
	/* this method isn`t suit for kernel 4.4,
	   so delete
	struct proc_dir_entry* entry;
	
	entry = proc_create(FREG_DEVICE_PROC_NAME, 0, NULL);
	if(entry) {
